...
function Cart() {
    ...
    const{products, currency, cartItems, removeFromCart, getCartItem, getCartAmount, getCartCount, updateCartItem, axios, user, setCartItems} =useAppcontext()
    ...
    const prod = products.find((item) => item._id === key); 
     if (prod) {
      tempArray.push({ ...prod, quantity: cartItems[key] });
    }
     }
